...
class CellTypeAnnotationSummary(Base):
    ...
    def __repr__(self):
        return f"CellTypeAnnotationSummary(id={self.id},)"
...
class CellTypeAnnotationSummaryCellTypeStatistics(Base):
    ...
    CellTypeAnnotationSummary_id = Column(Integer(), ForeignKey('CellTypeAnnotationSummary.id'), primary_key=True)
    cell_type_statistics_id = Column(Integer(), ForeignKey('CellTypeStatistics.id'), primary_key=True, nullable=False )
    

    def __repr__(self):
        return f"CellTypeAnnotationSummary_cell_type_statistics(CellTypeAnnotationSummary_id={self.CellTypeAnnotationSummary_id},cell_type_statistics_id={self.cell_type_statistics_id},)"
